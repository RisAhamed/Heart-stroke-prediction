...
from hs.constants.application import APP_HOST, APP_PORT
from hs.pipeline.prediction_pipeline import (HeartData,
                                                       HeartStrokeClassifier)
from hs.pipeline.train_pipeline import TrainPipeline
