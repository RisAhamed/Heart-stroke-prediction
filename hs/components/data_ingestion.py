...
import pandas as pd
from pandas import DataFrame
from hs.entity.config_entity import DataIngestionConfig
from hs.entity.artifact_entity import DataIngestionArtifact
from hs.exception import CustomException
from hs.logger import logging
from hs.utils.main_utils import read_yaml_file
# from hs.data_access.hs_data import StrokeData
from hs.constants.training_pipeline import SCHEMA_FILE_PATH
...
class DataIngestion:
    ...
    def export_data_into_feature_store(self)-> DataFrame:
        ...
        """
        try:
            logging.info(f"exporting  the data from the mongo db")
    ...
    def split_data_as_train_test(self, dataframe: DataFrame) -> None:
        ...
        try:
            ...
            logging.info("Exited the traiin test split")
